...
c
      ...
      subroutine symba5p_merge(t,dt,nbod,nbodm,ip1,ip2,mass,xh,yh,zh,
     &     vxb,vyb,vzb,ireci,irecl,svdotrold,iecnt,rpl,mergelst,
...
c...  Inputs and Outputs:
      real*8 mass(NTPMAX),xh(NTPMAX),yh(NTPMAX),zh(NTPMAX),eoff
...
c...  Executable code 
      ...
      if(rlim2.ge.rr2) then
         ...
         ip2l = ip2 
!$OMP CRITICAL (MERGE)
         call discard_mass_merge5p_mtiny(t,nbod,nbodm,ip1l,ip2l,mass,xh,
