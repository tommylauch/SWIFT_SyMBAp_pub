...
c
c             Input:
c                 xr           ==>  relative position of tp wrt planet
c                                   (real scalar)
c                 vxr          ==>  relative velocity of tp wrt planet
c                                   (real scalor)
...
c Last revision: 
      ...
      subroutine rmvs_chk_ind_symbap(xr,vxr,dt,r2crit,r2critp,iflag)
      include '../swift.inc'
      include 'rmvs.inc'
