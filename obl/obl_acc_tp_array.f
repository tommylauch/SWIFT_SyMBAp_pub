...
c Last revision: 
      ...
      subroutine obl_acc_tp_array(ntp,istat,msun,j2rp2,j4rp4,xht,
     &        irht,aoblxt)
...
c First get the bary acc. of each tp due to central oblate "sun"
      ...
      do n =1,ntp
         ...
         aoblxt(1,n) = fac1*xht(1,n)
         aoblxt(2,n) = fac1*xht(2,n)
         aoblxt(3,n) = (fac1 + fac2)*xht(3,n)
