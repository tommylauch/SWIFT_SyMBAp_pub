...
c Last revision: 2/22/94
      ...
      subroutine discard_pl_array(time,dt,nbod,ntp,mass,xh,vxh,
...
c...  Inputs: 
      ...
      real*8 vxh(3,nbod),xht(3,ntp),rplsq(ntp)
      real*8 vxht(3,ntp)
      real*8 time,dt
...
c...  Executable code 
     ...
     &              istat(j,3),' is too small at t=',time
               ...
               do i=2,nbod
                  xr = xht(:,j) - xh(:,i)
                  vxr = vxht(:,j) - vxh(:,i)
                  call discard_pl_close_array(xr,vxr,
