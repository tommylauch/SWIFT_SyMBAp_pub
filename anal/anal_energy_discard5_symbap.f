c*************************************************************************
c                          ANAL_ENERGY_DISCARD5_SYMBAP.F
c*************************************************************************
...
c Last revision:  
      ...
      subroutine anal_energy_discard5_symbap(iflg,nbod,nbodm,mass,j2rp2,
...
c...  iflg = 0
      ...
      if(leuse) then
         call anal_energy_mtiny_symbap(nbod,nbodm,mass,j2rp2,j4rp4,xh,
     &        vxh,ke,pot,energy,eltot)
      else
         ke = 0.0d0
         pot = 0.0d0
         energy = 0.0d0
      ...
      return	
      end      ! anal_energy_discard5_symbap
c-----------------------------------------------------------------------
