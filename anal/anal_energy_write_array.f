...
c Last revision: 12/27/96
      ...
      subroutine anal_energy_write_array(t,nbod,mass,j2rp2,j4rp4,xh,
     &     vxh,iu,fopenstat,eoff)
...
c Compute and print initial ke,pot,energy and ang. mom.
      call anal_energy_array(nbod,mass,j2rp2,j4rp4,xh,vxh,ke,pot,
     &                        energy,eltot)
