c*************************************************************************
c                          ANAL_ENERGY_DISCARD5_ARRAY.F
c*************************************************************************
...
c Last revision:  
      ...
      subroutine anal_energy_discard5_array(iflg,nbod,nbodm,mass,j2rp2,
...
c...  iflg = 0
      ...
      if(leuse) then
         call anal_energy_mtiny_array(nbod,nbodm,mass,j2rp2,j4rp4,xh,
     &        vxh,ke,pot,energy,eltot)
      ...
      return	
      end      ! anal_energy_discard5_array
c-----------------------------------------------------------------------
