...
c Last revision: 
      ...
      subroutine io_write_frame_r_symbap(time,nbod,ntp,mass,xh,vxh,
     &           xht,vxht,istat,oname,iu,fopenstat)
...
c...  write out planets
      do i=2,nbod
         gm = mass(1)+mass(i)
         id = -1*i
 	      call orbel_xv2el_symbap(xh(1:3,i),vxh(1:3,i),gm,ialpha,a,e,
...
c...  write out test particles
      ...
      do i=1,ntp
         if(istat(i,1).eq.0) then
            call orbel_xv2el_symbap(xht(1:3,i),vxht(1:3,i),gm,ialpha,a,
