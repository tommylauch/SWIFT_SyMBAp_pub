...
c Last revision: 7/11/94
      ...
      subroutine io_discard_write_array(init,time,nbod,ntp,xh,
     &     vxh,xht,vxht,istat,rstat,iu,rname,fopenstat,nleft)
