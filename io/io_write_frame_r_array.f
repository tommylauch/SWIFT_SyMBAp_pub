...
c Last revision: 
      ...
      subroutine io_write_frame_r_array(time,nbod,ntp,mass,xh,vxh,
...
c...  write out test particles
      ...
      do i=1,ntp
         if(istat(i,1).eq.0) then
            call orbel_xv2el_array(xht(1:3,i),vxht(1:3,i),gm,ialpha,a,
